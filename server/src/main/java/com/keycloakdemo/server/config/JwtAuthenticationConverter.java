...
/**
 * Custom JWT authentication converter that extracts Keycloak roles and checks token blacklist
 */
@Component
public class JwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public JwtAuthenticationConverter(TokenBlacklistService tokenBlacklistService, @Value("${keycloak.client-id}") String clientId) {
     ...
     *
     * @return Collection of SimpleGrantedAuthority objects representing the roles extracted from the JWT claims
     */
